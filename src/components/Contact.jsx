        ...
        >
            ...
            >
                ...
                >
                    <label className='flex flex-col'>
                        ...
                        <input
                            ...
                            className='bg-tertiary py-4 px-6 placeholder:text-secondary text-black-100 rounded-lg outline-none border-none font-medium'
                        />
                    </label>
                    <label className='flex flex-col'>
                ...
                <div className='mt-8 flex gap-6 justify-center lg:justify-start'>
                    <a
                        href='https://linkedin.com/in/akash-degavath'
                        target='_blank'
                        rel='noreferrer'
                        className='text-black-100 hover:text-[#915eff] text-3xl transition-colors'
                    >
                        <FaLinkedin />
                    </a>
                    <a
                        href='https://github.com/akashnayak812'
                        target='_blank'
                        rel='noreferrer'
                        className='text-black-100 hover:text-[#915eff] text-3xl transition-colors'
                    >
                    ...
                    <a
                        href='mailto:akashswaero@gmail.com'
                        className='text-black-100 hover:text-[#915eff] text-3xl transition-colors'
                    >
                        <FaEnvelope />
                    </a>
